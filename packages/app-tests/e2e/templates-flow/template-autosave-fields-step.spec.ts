...
const setupTemplateAndNavigateToFieldsStep = async (page: Page) => {
  ...
  await page.getByPlaceholder('Email').fill('recipient1@email.com');
  await page.getByPlaceholder('Name').fill('Recipient 1');

  await page.getByRole('button', { name: 'Add Placeholder Recipient' }).click();

  await page.getByPlaceholder('Email').nth(1).fill('recipient2@pathwaygroup.co.uk');
...
test.describe('AutoSave Fields Step', () => {
  test('should autosave the fields without advanced settings', async ({ page }) => {
    ...
    await page.getByRole('option', { name: 'Recipient 2 (recipient2@pathwaygroup.co.uk)' }).click();
  ...
  test('should autosave the field deletion', async ({ page }) => {
    ...
    await page.getByRole('combobox').first().click();
    await page.getByRole('option', { name: 'Recipient 1 (recipient1@email.com)' }).click();
